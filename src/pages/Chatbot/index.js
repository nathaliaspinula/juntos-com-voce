...
export default function () {
  ...
  useEffect(() => {
    setMessage(
      "Para mapearmos os casos de Coronavirus, precisamos acessar a sua localização"
    );
        ...
        (error) => {
          switch (error.code) {
            case error.PERMISSION_DENIED:
              setMessage(
                "É necessário que você permita o acesso à sua localização."
              );
              break;
  ...
  return (
    <div className={autoExameOpen ? "frame frame--big" : "frame"} id="frame">
      <div
        className={
      ...
      >
        {chatBotEnable ? (
          <iframe
            title="chatbot"
            src="https://webchat.botframework.com/embed/JuntosComVoce?s=wdTu3m0511E.RRw4QNr-npvgDPUSTVjdzHxv2jNDGoFBHcTHSuDyv4g"
          ></iframe>
        ) : (
          <form
            action=""
          ...
          >
            <h2 className="chatbot__title">
              Antes de iniciar o chat, precisamos de algumas informações
            </h2>
            ...
            <div className="chatbot__container ">
              <label className="chatbot__location" id="message">
                {message}
              </label>
              <input
                type="hidden"
                name="localizacao"
                id="localizacao"
                className="chatbot__input chatbot__input--hidden"
                required
              />
            </div>
            ...
            <div className="chatbot__container chatbot__container--horizontal">
              <input
                ...
                required
              />
              <label className="chatbot__label--checkbox">
                Li e aceito os <a href="http://">termos de uso de dados</a>
              </label>
            </div>
